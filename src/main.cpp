...
const string strMessageMagic = "blurry Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 10) // premine 9000
    {
        nSubsidy = 900 * COIN;
    }
    ...
    else if(pindexBest->nHeight < 130) // 80000
    {
        nSubsidy = 800 * COIN;
    }
    else if(pindexBest->nHeight < 530) // 120000
    {
        nSubsidy = 300 * COIN;
    }
    else if(pindexBest->nHeight < 1030) // 50000
    {
        nSubsidy = 100 * COIN;
    }
    else if(pindexBest->nHeight < 5030) // 160000
    {
        nSubsidy = 40 * COIN;
    }
    else if(pindexBest->nHeight < 10030) // 50000
    {
        nSubsidy = 10 * COIN;
    }
    else if(pindexBest->nHeight < 20030) // 30000
    {
        nSubsidy = 3 * COIN;
    }
...
// blurry: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "blurry", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Blurry coin";
        CTransaction txNew;
        txNew.nTime = 1446832304;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xbdceeaae918b04dc2deaeab6e439d5d5bc2ec0bd23665ac31a5896f0d757d653"));
        block.print();
